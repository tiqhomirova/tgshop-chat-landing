...
const imgTrust_41 = `${import.meta.env.BASE_URL}assets/logo-third.png`;
        ...
        <div className="h-[415px] relative shrink-0 w-[602px]" data-node-id="40002757:8485" data-name="right">
          <div className="absolute content-stretch drop-shadow-[-2px_-2px_3px_rgba(0,0,0,0.1)] flex h-[300.9px] items-start left-[207.4px] overflow-clip rounded-[20px] top-[56.53px] w-[274.55px]" data-node-id="40002757:8486" data-name="mock-body">
            <div className="bg-white content-stretch flex flex-col gap-[2px] h-[300.9px] items-start overflow-clip px-[10px] py-[14px] relative shrink-0 w-[274.55px]" data-node-id="40002757:8487" data-name="chats">
              ...
              <div className="bg-[#f3f8ff] content-stretch flex gap-[12px] h-[44px] items-start px-[10px] py-[6px] overflow-hidden relative rounded-[10px] shrink-0 w-[253.3px]" data-node-id="40002757:8500" data-name="ch">
                ...
                <div className="content-stretch flex flex-col gap-[2px] items-start relative shrink-0 w-[118.575px]" data-node-id="40002757:8503" data-name="main">
                  <div className="content-stretch flex items-baseline gap-[4px] overflow-clip relative shrink-0 w-[100.789px]" data-node-id="40002757:8504" data-name="top">
              ...
              <div className="bg-[#f3f8ff] content-stretch flex gap-[12px] h-[44px] items-start px-[10px] py-[6px] overflow-hidden relative rounded-[10px] shrink-0 w-[253.3px]" data-node-id="40002757:8510" data-name="ch">
                ...
                <div className="content-stretch flex flex-col gap-[2px] items-start relative shrink-0 w-[118.575px]" data-node-id="40002757:8513" data-name="main">
                  <div className="content-stretch flex items-baseline gap-[4px] overflow-clip relative shrink-0 w-[100.789px]" data-node-id="40002757:8514" data-name="top">
                    <p className="[word-break:break-word] font-['SF_Pro:Semibold',sans-serif] font-[590] leading-[1.5] relative shrink-0 text-[#0a1519] text-[11px] tracking-[-0.11px] whitespace-nowrap" data-node-id="40002757:8515" style={{ fontVariationSettings: "'wdth' 100" }}>{HERO_CHAT_NAMES[1]}</p>
                  ...
                  <p className="[word-break:break-word] font-['SF_Pro:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[#595959] text-[11px] tracking-[-0.11px] w-full overflow-hidden text-ellipsis whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>Когда доставка?</p>
                </div>
              ...
              <div className="content-stretch flex gap-[12px] h-[44px] items-start px-[10px] py-[6px] overflow-hidden relative rounded-[10px] shrink-0 w-[253.3px]" data-node-id="40002757:8520" data-name="ch">
                ...
                <div className="content-stretch flex flex-col gap-[2px] items-start relative shrink-0 w-[114.325px]" data-node-id="40002757:8523" data-name="main">
                  <div className="content-stretch flex items-baseline gap-[4px] overflow-clip relative shrink-0 w-[97.176px]" data-node-id="40002757:8524" data-name="top">
                    <p className="[word-break:break-word] font-['SF_Pro:Semibold',sans-serif] font-[590] leading-[1.5] relative shrink-0 text-[#0a1519] text-[11px] tracking-[-0.11px] whitespace-nowrap" data-node-id="40002757:8525" style={{ fontVariationSettings: "'wdth' 100" }}>{HERO_CHAT_NAMES[2]}</p>
              ...
              <div className="content-stretch flex gap-[12px] h-[44px] items-start px-[10px] py-[6px] overflow-hidden relative rounded-[10px] shrink-0 w-[253.3px]" data-node-id="40002757:8531" data-name="ch">
                ...
                <div className="content-stretch flex flex-col gap-[2px] items-start relative shrink-0 w-[114.325px]" data-node-id="40002757:8534" data-name="main">
                  <div className="content-stretch flex items-baseline gap-[4px] overflow-clip relative shrink-0 w-[97.176px]" data-node-id="40002757:8535" data-name="top">
                    <p className="[word-break:break-word] font-['SF_Pro:Semibold',sans-serif] font-[590] leading-[1.5] relative shrink-0 text-[#0a1519] text-[11px] tracking-[-0.11px] whitespace-nowrap" data-node-id="40002757:8536" style={{ fontVariationSettings: "'wdth' 100" }}>{HERO_CHAT_NAMES[3]}</p>
                  ...
                  <p className="[word-break:break-word] font-['SF_Pro:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[#595959] text-[11px] tracking-[-0.11px] w-full overflow-hidden text-ellipsis whitespace-nowrap" data-node-id="40002757:8539" style={{ fontVariationSettings: "'wdth' 100" }}>Спасибо!</p>
                </div>
              ...
              <div className="bg-[#f3f8ff] content-stretch flex gap-[12px] h-[44px] items-start px-[10px] py-[6px] overflow-hidden relative rounded-[10px] shrink-0 w-[253.3px]" data-node-id="40002757:8542" data-name="ch">
                ...
                <div className="content-stretch flex flex-col gap-[2px] items-start relative shrink-0 w-[115.175px]" data-node-id="40002757:8545" data-name="main">
                  <div className="content-stretch flex items-baseline gap-[4px] overflow-clip relative shrink-0 w-[97.899px]" data-node-id="40002757:8546" data-name="top">
                    <p className="[word-break:break-word] font-['SF_Pro:Semibold',sans-serif] font-[590] leading-[1.5] relative shrink-0 text-[#0a1519] text-[11px] tracking-[-0.11px] whitespace-nowrap" data-node-id="40002757:8547" style={{ fontVariationSettings: "'wdth' 100" }}>{HERO_CHAT_NAMES[4]}</p>
              ...
              <div className="bg-[#f3f8ff] content-stretch flex gap-[12px] h-[44px] items-start px-[10px] py-[6px] overflow-hidden relative rounded-[10px] shrink-0 w-[253.3px]" data-node-id="40002757:8553" data-name="ch">
                ...
                <div className="content-stretch flex flex-col gap-[2px] items-start relative shrink-0 w-[115.175px]" data-node-id="40002757:8556" data-name="main">
                  <div className="content-stretch flex items-baseline gap-[4px] overflow-clip relative shrink-0 w-[97.899px]" data-node-id="40002757:8557" data-name="top">
                    <p className="[word-break:break-word] font-['SF_Pro:Semibold',sans-serif] font-[590] leading-[1.5] relative shrink-0 text-[#0a1519] text-[11px] tracking-[-0.11px] whitespace-nowrap" data-node-id="40002757:8558" style={{ fontVariationSettings: "'wdth' 100" }}>{HERO_CHAT_NAMES[5]}</p>
                  ...
                  <p className="[word-break:break-word] font-['SF_Pro:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[#595959] text-[11px] tracking-[-0.11px] w-full overflow-hidden text-ellipsis whitespace-nowrap" data-node-id="40002757:8561" style={{ fontVariationSettings: "'wdth' 100" }}>Можно скидку?</p>
                </div>
          ...
          <div className="absolute content-stretch flex flex-col h-[400.35px] items-start left-[91.8px] pb-[16px] pt-[14px] px-[14px] top-[2.55px] w-[172.55px]" data-node-id="40002757:8564" data-name="shop">
            ...
            <div className={`h-[322.15px] relative shrink-0 w-[148.75px] ${T.isRU ? '' : 'rounded-[20px] shadow-[-1px_-1px_6px_0px_rgba(0,0,0,0.2)]'}`} data-node-id="40002757:8572" data-name="Frame 2136140004 1">
      ...
      <div className="content-stretch flex flex-col gap-[16px] items-start overflow-clip relative shrink-0 w-[928px]" data-node-id="40002673:8253" data-name="cases-row">
        <div className="content-stretch flex gap-[16px] items-start overflow-clip relative shrink-0 w-full" data-node-id="40002673:8254" data-name="Frame">
          ...
          <div className="bg-white border border-[#ebedf2] border-solid content-stretch flex flex-[1_0_0] flex-col gap-[24px] items-start min-w-px overflow-clip p-[24px] relative rounded-[16px]" data-node-id="40002673:8273" data-name="case-Around You">
            <div className="[word-break:break-word] bg-[rgba(33,178,99,0.14)] content-stretch flex gap-[6px] items-center leading-[normal] overflow-clip px-[10px] py-[4px] relative rounded-[10px] shrink-0 text-[#0f8c33] whitespace-nowrap">
              <p className="font-['SF_Pro:Bold',sans-serif] font-bold relative shrink-0 text-[10px]" style={{ fontVariationSettings: "'wdth' 100" }}>✓</p>
              <p className="font-['SF_Pro:Semibold',sans-serif] font-[590] relative shrink-0 text-[11px]" style={{ fontVariationSettings: "'wdth' 100" }}>{T.zeroAdsBadge}</p>
            </div>
            <div className="bg-white content-stretch flex gap-[20px] items-start overflow-clip relative shrink-0">
              <div className="bg-white content-stretch flex flex-col gap-[6px] items-start overflow-clip relative shrink-0">
        ...
        <div className="bg-white border border-[rgba(0,0,0,0.06)] border-solid content-stretch flex flex-[1_0_0] flex-col items-start min-w-px overflow-clip pb-[20px] pt-[24px] px-[20px] relative rounded-[24px]" data-name="step">
          ...
          <div className="bg-white border border-[#ebedf2] border-solid content-stretch flex flex-col gap-[8px] items-start overflow-clip p-[18px] relative rounded-[16px] shrink-0 w-full" data-name="m1-setup">
            {[
              ...
              { label: 'Оплата', value: T.setupPayments },
          ...
          <div className="bg-white border border-[#ebedf2] border-solid content-stretch flex flex-col gap-[10px] items-start overflow-clip p-[18px] relative rounded-[16px] shrink-0 w-full" data-name="m2-chat">
            ...
            <div className="bg-white content-stretch flex items-start justify-end overflow-clip relative shrink-0 w-full">
              <div className="bg-[#e8f2ff] content-stretch flex items-start overflow-clip px-[12px] py-[10px] relative rounded-[12px] shrink-0 w-[220px]">
                <p className="[word-break:break-word] font-['SF_Pro:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#121726] text-[13px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>{T.chatPriceReply}</p>
              </div>
            </div>
      ...
      <div className="content-stretch flex gap-[80px] items-center relative shrink-0 w-[928px]" data-name="kf-card">
        ...
        <div className="bg-white content-stretch flex gap-[10px] items-start overflow-clip p-[16px] relative rounded-[20px] shadow-[0px_12px_32px_0px_rgba(13,18,31,0.08)] shrink-0 w-[440px]" data-name="kf-status-board">
          {[
            ...
            { label: 'Открыт', labelColor: '#f5a624', labelBg: 'rgba(245,166,36,0.12)', count: '12', cards: [{ name: HERO_CHAT_NAMES[4], msg: 'Когда доставка?', time: '23 мин' }, { name: HERO_CHAT_NAMES[2], msg: 'Адрес?', time: '5 мин' }] },
  ...
  const cards = [
    {
      ...
      tags: [
        ...
        { dot: imgSol_Ellipse2, label: T.importChip3 },
      ],
    },
    {
      ...
      tags: [
        { dot: imgSol_Ellipse1, label: T.paymentChip1 },
        { dot: imgSol_Ellipse2, label: T.paymentChip2 },
        { dot: imgSol_Ellipse3, label: T.paymentChip3 },
        { dot: imgSol_Ellipse4, label: T.paymentChip4 },
      ],
    },
    {
...
function Pricing({ isYear, setPeriod }: { isYear: boolean; setPeriod: (p: 'month' | 'year') => void }) {
  ...
  const startCard = {
    name: 'Старт',
    price: isYear ? T.priceStarterYear : T.priceStarterMonth,
    hint: isYear ? T.priceStarterMonth : '−20% при оплате за год',
  ...
  const businessCard = {
    name: 'Бизнес',
    price: isYear ? T.priceBusinessYear : T.priceBusinessMonth,
    hint: isYear ? T.priceBusinessMonth : '−20% при оплате за год',
  ...
  const premiumCard = {
    name: 'Премиум',
    price: isYear ? T.priceProYear : T.priceProMonth,
    hint: isYear ? T.priceProMonth : '−20% при оплате за год',
