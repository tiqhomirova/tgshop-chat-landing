...
const imgTrust_221 = "https://www.figma.com/api/mcp/asset/fbc06494-4058-475d-8478-7b244e96f969";
const imgTrust_51 = "https://www.figma.com/api/mcp/asset/bc2d7bf2-c695-47e8-92cd-9eb3dde2ad56";
const imgTrust_41 = "https://www.figma.com/api/mcp/asset/9242cb05-6bc9-4964-b0bb-aeb629305438";
  ...
  return (
    <div className={className || "h-[80px] overflow-clip relative w-[1216px]"} data-node-id="40002524:7510" data-name="Section-upper/Default">
      <div className="-translate-y-1/2 absolute h-[80px] left-[-2006.23px] right-[2006.23px] top-1/2" data-node-id="40002524:7511" data-name="List">
            ...
            <div className="absolute inset-[30px_65.75px_30px_18.25px]" data-node-id="40002524:7514" data-name="SVG">
              <div className="absolute inset-0 overflow-clip">
                <div className="absolute contents inset-0">
                  <div className="absolute inset-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-size-[96px_20px]" style={{ maskImage: `url('${imgTrust_Group}')` }}>
                    <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgTrust_Group1} />
                  </div>
                </div>
              </div>
            </div>
          </div>
          <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%-479.26px)] top-1/2 w-px" />
          <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[80px] left-[calc(50%-364.76px)] overflow-clip rounded-[8px] top-1/2 w-[180px]">
            <div className="absolute inset-[31.01px_58.75px_31.04px_11.25px]">
              <div className="absolute inset-0 overflow-clip">
                <div className="absolute contents inset-0">
                  <div className="absolute inset-[-0.01%_0.01%_-0.01%_0] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px_0.002px] mask-size-[110px_17.95px]" style={{ maskImage: `url('${imgTrust_Group2}')` }}>
                    <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgTrust_Group3} />
                  </div>
                </div>
              </div>
            </div>
          </div>
          <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%-250.26px)] top-1/2 w-px" />
          <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[80px] left-[calc(50%-135.76px)] overflow-clip rounded-[8px] top-1/2 w-[180px]">
            <div className="absolute inset-[34px_57.75px_34px_10.25px]">
              <div className="absolute inset-0 overflow-clip">
                <div className="absolute contents inset-0">
                  <div className="absolute inset-[0_-0.02%_0_0.01%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-0.008px_0px] mask-size-[112px_12px]" style={{ maskImage: `url('${imgTrust_Group4}')` }}>
                    <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgTrust_Group5} />
                  </div>
                </div>
              </div>
            </div>
          </div>
          <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%-21.26px)] top-1/2 w-px" />
          <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[80px] left-[calc(50%+93.24px)] overflow-clip rounded-[8px] top-1/2 w-[180px]">
            <div className="absolute inset-[30px_65.75px_30px_18.25px]">
              <div className="absolute inset-0 overflow-clip">
                <div className="absolute contents inset-0">
                  <div className="absolute inset-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-size-[96px_20px]" style={{ maskImage: `url('${imgTrust_Group}')` }}>
                    <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgTrust_Group6} />
                  </div>
                </div>
              </div>
            </div>
          </div>
          <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+207.74px)] top-1/2 w-px" />
          <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[80px] left-[calc(50%+322.24px)] overflow-clip rounded-[8px] top-1/2 w-[180px]">
            <div className="absolute inset-[34px_61.75px_34px_14.25px]">
              <div className="absolute inset-0 overflow-clip">
                <div className="absolute contents inset-0">
                  <div className="absolute inset-[-0.18%_0.02%_-0.02%_0] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px_0.021px] mask-size-[104px_12px]" style={{ maskImage: `url('${imgTrust_Group7}')` }}>
                    <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgTrust_Group8} />
                  </div>
                </div>
              </div>
            </div>
          </div>
          <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+436.74px)] top-1/2 w-px" />
          <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[80px] left-[calc(50%+551.24px)] overflow-clip rounded-[8px] top-1/2 w-[180px]">
            <div className="absolute inset-[34px_52.75px_34px_5.25px]">
              <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgTrust_Svg} />
            </div>
          </div>
          <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+665.74px)] top-1/2 w-px" />
        </div>
        <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[80px] left-[calc(50%+828.5px)] overflow-clip rounded-[8px] top-1/2 w-[180px]">
          <div className="absolute inset-[30px_65.75px_30px_18.25px]">
            <div className="absolute inset-0 overflow-clip">
              <div className="absolute contents inset-0">
                <div className="absolute inset-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-size-[96px_20px]" style={{ maskImage: `url('${imgTrust_Group}')` }}>
        ...
        <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+943px)] top-1/2 w-px" />
        <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[80px] left-[calc(50%+1057.5px)] overflow-clip rounded-[8px] top-1/2 w-[180px]">
          <div className="absolute inset-[31.01px_58.75px_31.04px_11.25px]">
            <div className="absolute inset-0 overflow-clip">
              <div className="absolute contents inset-0">
                <div className="absolute inset-[-0.01%_0.01%_-0.01%_0] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px_0.002px] mask-size-[110px_17.95px]" style={{ maskImage: `url('${imgTrust_Group2}')` }}>
        ...
        <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+1172px)] top-1/2 w-px" />
        <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[80px] left-[calc(50%+1286.5px)] overflow-clip rounded-[8px] top-1/2 w-[180px]">
          <div className="absolute inset-[34px_57.75px_34px_10.25px]">
            <div className="absolute inset-0 overflow-clip">
              <div className="absolute contents inset-0">
                <div className="absolute inset-[0_-0.02%_0_0.01%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-0.008px_0px] mask-size-[112px_12px]" style={{ maskImage: `url('${imgTrust_Group4}')` }}>
        ...
        <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+1401px)] top-1/2 w-px" />
        <div className="-translate-y-1/2 absolute aspect-[640/640] border border-[#b9b9b9] border-solid left-[2019.26px] right-[-863.26px] rounded-[200px] top-1/2">
        ...
        <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+1511.76px)] top-1/2 w-px" />
        <div className="-translate-y-1/2 absolute aspect-[138/27] left-[2383.48px] right-[-1295.26px] top-[calc(50%-0.5px)]">
          <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgTrust_Vector} />
        </div>
        <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+1734.98px)] top-1/2 w-px" />
        <div className="-translate-y-1/2 absolute aspect-[1024/216] left-[2160.26px] right-[-1086.48px] top-1/2">
          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgTrust_YvesRocherLogoSvg3} />
        </div>
        <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+1943.76px)] top-1/2 w-px" />
        <div className="-translate-y-1/2 absolute aspect-[708/178] left-[2592.26px] right-[-1463.76px] top-1/2">
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <img alt="" className="absolute h-[155.06%] left-0 max-w-none top-[-27.53%] w-full" src={imgTrust_61} />
          </div>
        </div>
        <div className="-translate-y-1/2 absolute aspect-[420/114] left-[2761.23px] mix-blend-darken right-[-1679.23px] top-1/2">
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <img alt="" className="absolute h-[145.61%] left-[-7.86%] max-w-none top-[-19.3%] w-[115.48%]" src={imgTrust_221} />
          </div>
        </div>
        <div className="-translate-y-1/2 absolute aspect-[1639/500] left-[2976.23px] mix-blend-darken right-[-1898.23px] top-1/2">
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <img alt="" className="absolute h-[219.8%] left-[-0.92%] max-w-none top-[-60.6%] w-[102.5%]" src={imgTrust_51} />
          </div>
        </div>
        <div className="-translate-y-1/2 absolute aspect-[858/112] left-[3181.23px] mix-blend-darken right-[-2165.23px] top-1/2">
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <img alt="" className="absolute h-[150%] left-[-2.56%] max-w-none top-[-24.11%] w-[105.59%]" src={imgTrust_41} />
          </div>
        </div>
        <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+2112.26px)] top-1/2 w-px" />
        <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+2327.73px)] top-1/2 w-px" />
        <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+2546.73px)] top-1/2 w-px" />
        <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+2735px)] top-1/2 w-px" />
        <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[80px] left-[calc(50%+2849.5px)] overflow-clip rounded-[8px] top-1/2 w-[180px]">
          <div className="absolute inset-[30px_67px_30px_17px]">
            <div className="absolute inset-0 overflow-clip">
              <div className="absolute contents inset-0">
                <div className="absolute inset-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-size-[96px_20px]" style={{ maskImage: `url('${imgTrust_Group}')` }}>
                  <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgTrust_Group6} />
        ...
        <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+2964px)] top-1/2 w-px" />
        <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[80px] left-[calc(50%+3078.5px)] overflow-clip rounded-[8px] top-1/2 w-[180px]">
          <div className="absolute inset-[34px_63px_34px_13px]">
            <div className="absolute inset-0 overflow-clip">
              <div className="absolute contents inset-0">
                <div className="absolute inset-[-0.18%_0.02%_-0.02%_0] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px_0.021px] mask-size-[104px_12px]" style={{ maskImage: `url('${imgTrust_Group7}')` }}>
                  <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgTrust_Group8} />
        ...
        <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+3193px)] top-1/2 w-px" />
        <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[80px] left-[calc(50%+3307.5px)] overflow-clip rounded-[8px] top-1/2 w-[180px]">
          <div className="absolute inset-[34px_54px_34px_4px]">
            <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgTrust_Svg} />
          </div>
        </div>
        <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+3422px)] top-1/2 w-px" />
      </div>
      <div className="absolute bg-gradient-to-l from-[rgba(246,247,249,0)] h-[79px] left-0 to-[#f6f7f9] top-[0.6px] w-[60px]" />
      <div className="absolute bg-gradient-to-l from-[#f6f7f9] h-[79px] right-0 to-[rgba(246,247,249,0)] top-[0.6px] w-[60px]" />
    </div>
  );
}
