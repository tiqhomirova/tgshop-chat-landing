...
const imgVector = "https://www.figma.com/api/mcp/asset/ac64de1a-1bca-4c23-ae2e-2b0ca70a2543";
...
function SectionUpperDefault({ className }: { className?: string }) {
  return (
    <div className={className || "h-[80px] overflow-clip relative w-[1216px]"} data-node-id="40002524:7510" data-name="Section-upper/Default">
      <div className="-translate-y-1/2 absolute h-[80px] left-[-2006.23px] right-[2006.23px] top-1/2" data-node-id="40002524:7511" data-name="List">
        <div className="absolute h-[80px] left-[-18.74px] overflow-clip top-0 w-[1350px]" data-node-id="40002524:7512" data-name="Item">
          <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[80px] left-[calc(50%-593.76px)] overflow-clip rounded-[8px] top-1/2 w-[180px]" data-node-id="40002524:7513" data-name="Background">
            <div className="absolute inset-[30px_65.75px_30px_18.25px]" data-node-id="40002524:7514" data-name="SVG">
              <div className="absolute inset-0 overflow-clip" data-node-id="40002524:7515" data-name="svg-2019416039_6035">
                <div className="absolute contents inset-0" data-node-id="40002524:7516" data-name="Clip path group">
                  <div className="absolute inset-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-size-[96px_20px]" data-node-id="40002524:7519" style={{ maskImage: `url('${imgGroup}')` }} data-name="Group">
          ...
          <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%-479.26px)] top-1/2 w-px" data-node-id="40002524:7531" data-name="Vertical Divider" />
          <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[80px] left-[calc(50%-364.76px)] overflow-clip rounded-[8px] top-1/2 w-[180px]" data-node-id="40002524:7532" data-name="Background">
            <div className="absolute inset-[31.01px_58.75px_31.04px_11.25px]" data-node-id="40002524:7533" data-name="SVG">
              <div className="absolute inset-0 overflow-clip" data-node-id="40002524:7534" data-name="svg241134563_7233">
                <div className="absolute contents inset-0" data-node-id="40002524:7535" data-name="Clip path group">
                  <div className="absolute inset-[-0.01%_0.01%_-0.01%_0] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px_0.002px] mask-size-[110px_17.95px]" data-node-id="40002524:7538" style={{ maskImage: `url('${imgGroup2}')` }} data-name="Group">
          ...
          <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%-250.26px)] top-1/2 w-px" data-node-id="40002524:7551" data-name="Vertical Divider" />
          <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[80px] left-[calc(50%-135.76px)] overflow-clip rounded-[8px] top-1/2 w-[180px]" data-node-id="40002524:7552" data-name="Background">
            <div className="absolute inset-[34px_57.75px_34px_10.25px]" data-node-id="40002524:7553" data-name="SVG">
              <div className="absolute inset-0 overflow-clip" data-node-id="40002524:7554" data-name="svg2145606225_4570">
                <div className="absolute contents inset-0" data-node-id="40002524:7555" data-name="Clip path group">
                  <div className="absolute inset-[0_-0.02%_0_0.01%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-0.008px_0px] mask-size-[112px_12px]" data-node-id="40002524:7558" style={{ maskImage: `url('${imgGroup4}')` }} data-name="Group">
          ...
          <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%-21.26px)] top-1/2 w-px" data-node-id="40002524:7560" data-name="Vertical Divider" />
          <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[80px] left-[calc(50%+93.24px)] overflow-clip rounded-[8px] top-1/2 w-[180px]" data-node-id="40002524:7561" data-name="Background">
            <div className="absolute inset-[30px_65.75px_30px_18.25px]" data-node-id="40002524:7562" data-name="SVG">
              <div className="absolute inset-0 overflow-clip" data-node-id="40002524:7563" data-name="svg-1193675701_6046">
                <div className="absolute contents inset-0" data-node-id="40002524:7564" data-name="Clip path group">
                  <div className="absolute inset-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-size-[96px_20px]" data-node-id="40002524:7567" style={{ maskImage: `url('${imgGroup}')` }} data-name="Group">
          ...
          <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+207.74px)] top-1/2 w-px" data-node-id="40002524:7579" data-name="Vertical Divider" />
          <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[80px] left-[calc(50%+322.24px)] overflow-clip rounded-[8px] top-1/2 w-[180px]" data-node-id="40002524:7580" data-name="Background">
            <div className="absolute inset-[34px_61.75px_34px_14.25px]" data-node-id="40002524:7581" data-name="SVG">
              <div className="absolute inset-0 overflow-clip" data-node-id="40002524:7582" data-name="svg-1200228636_8480">
                <div className="absolute contents inset-0" data-node-id="40002524:7583" data-name="Clip path group">
                  <div className="absolute inset-[-0.18%_0.02%_-0.02%_0] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px_0.021px] mask-size-[104px_12px]" data-node-id="40002524:7586" style={{ maskImage: `url('${imgGroup7}')` }} data-name="Group">
          ...
          <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+436.74px)] top-1/2 w-px" data-node-id="40002524:7598" data-name="Vertical Divider" />
          <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[80px] left-[calc(50%+551.24px)] overflow-clip rounded-[8px] top-1/2 w-[180px]" data-node-id="40002524:7599" data-name="Background">
            <div className="absolute inset-[34px_52.75px_34px_5.25px]" data-node-id="40002524:7600" data-name="SVG">
              <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgSvg} />
            </div>
          </div>
          <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+665.74px)] top-1/2 w-px" data-node-id="40002524:7610" data-name="Vertical Divider" />
        </div>
        <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[80px] left-[calc(50%+828.5px)] overflow-clip rounded-[8px] top-1/2 w-[180px]" data-node-id="40002524:7611" data-name="Background">
          <div className="absolute inset-[30px_65.75px_30px_18.25px]" data-node-id="40002524:7612" data-name="SVG">
            <div className="absolute inset-0 overflow-clip" data-node-id="40002524:7613" data-name="svg-2019416039_6035">
              <div className="absolute contents inset-0" data-node-id="40002524:7614" data-name="Clip path group">
                <div className="absolute inset-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-size-[96px_20px]" data-node-id="40002524:7617" style={{ maskImage: `url('${imgGroup}')` }} data-name="Group">
                  <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgGroup1} />
                </div>
              </div>
            </div>
        ...
        <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+943px)] top-1/2 w-px" data-node-id="40002524:7629" data-name="Vertical Divider" />
        <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[80px] left-[calc(50%+1057.5px)] overflow-clip rounded-[8px] top-1/2 w-[180px]" data-node-id="40002524:7630" data-name="Background">
          <div className="absolute inset-[31.01px_58.75px_31.04px_11.25px]" data-node-id="40002524:7631" data-name="SVG">
            <div className="absolute inset-0 overflow-clip" data-node-id="40002524:7632" data-name="svg241134563_7233">
              <div className="absolute contents inset-0" data-node-id="40002524:7633" data-name="Clip path group">
                <div className="absolute inset-[-0.01%_0.01%_-0.01%_0] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px_0.002px] mask-size-[110px_17.95px]" data-node-id="40002524:7636" style={{ maskImage: `url('${imgGroup2}')` }} data-name="Group">
                  <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgGroup3} />
                </div>
              </div>
            </div>
        ...
        <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+1172px)] top-1/2 w-px" data-node-id="40002524:7649" data-name="Vertical Divider" />
        <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[80px] left-[calc(50%+1286.5px)] overflow-clip rounded-[8px] top-1/2 w-[180px]" data-node-id="40002524:7650" data-name="Background">
          <div className="absolute inset-[34px_57.75px_34px_10.25px]" data-node-id="40002524:7651" data-name="SVG">
            <div className="absolute inset-0 overflow-clip" data-node-id="40002524:7652" data-name="svg2145606225_4570">
              <div className="absolute contents inset-0" data-node-id="40002524:7653" data-name="Clip path group">
                <div className="absolute inset-[0_-0.02%_0_0.01%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-0.008px_0px] mask-size-[112px_12px]" data-node-id="40002524:7656" style={{ maskImage: `url('${imgGroup4}')` }} data-name="Group">
                  <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgGroup5} />
                </div>
              </div>
            </div>
        ...
        <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+1401px)] top-1/2 w-px" data-node-id="40002524:7658" data-name="Vertical Divider" />
        <div className="-translate-y-1/2 absolute aspect-[640/640] border border-[#b9b9b9] border-solid left-[2019.26px] right-[-863.26px] rounded-[200px] top-1/2" data-node-id="40002524:7659" data-name="photo_2025-08-26 15.09.21 1">
        ...
        <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+1511.76px)] top-1/2 w-px" data-node-id="40002524:7660" data-name="Vertical Divider" />
        <div className="-translate-y-1/2 absolute aspect-[138/27] left-[2383.48px] right-[-1295.26px] top-[calc(50%-0.5px)]" data-node-id="40002524:7661" data-name="Vector">
          <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgVector} />
        </div>
        <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+1734.98px)] top-1/2 w-px" data-node-id="40002524:7662" data-name="Vertical Divider" />
        <div className="-translate-y-1/2 absolute aspect-[1024/216] left-[2160.26px] right-[-1086.48px] top-1/2" data-node-id="40002524:7663" data-name="Yves_Rocher_logo.svg 3">
          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgYvesRocherLogoSvg3} />
        </div>
        <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+1943.76px)] top-1/2 w-px" data-node-id="40002524:7664" data-name="Vertical Divider" />
        <div className="-translate-y-1/2 absolute aspect-[708/178] left-[2592.26px] right-[-1463.76px] top-1/2" data-node-id="40002524:7665" data-name="логотипы6 1">
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <img alt="" className="absolute h-[155.06%] left-0 max-w-none top-[-27.53%] w-full" src={img61} />
          </div>
        </div>
        <div className="-translate-y-1/2 absolute aspect-[420/114] left-[2761.23px] mix-blend-darken right-[-1679.23px] top-1/2" data-node-id="40002524:7666" data-name="логотипы2_2 1">
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <img alt="" className="absolute h-[145.61%] left-[-7.86%] max-w-none top-[-19.3%] w-[115.48%]" src={img221} />
          </div>
        </div>
        <div className="-translate-y-1/2 absolute aspect-[1639/500] left-[2976.23px] mix-blend-darken right-[-1898.23px] top-1/2" data-node-id="40002524:7667" data-name="логотипы5 1">
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <img alt="" className="absolute h-[219.8%] left-[-0.92%] max-w-none top-[-60.6%] w-[102.5%]" src={img51} />
          </div>
        </div>
        <div className="-translate-y-1/2 absolute aspect-[858/112] left-[3181.23px] mix-blend-darken right-[-2165.23px] top-1/2" data-node-id="40002524:7668" data-name="логотипы4 1">
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <img alt="" className="absolute h-[150%] left-[-2.56%] max-w-none top-[-24.11%] w-[105.59%]" src={img41} />
          </div>
        </div>
        <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+2112.26px)] top-1/2 w-px" data-node-id="40002524:7669" data-name="Vertical Divider" />
        <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+2327.73px)] top-1/2 w-px" data-node-id="40002524:7670" data-name="Vertical Divider" />
        <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+2546.73px)] top-1/2 w-px" data-node-id="40002524:7671" data-name="Vertical Divider" />
        <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+2735px)] top-1/2 w-px" data-node-id="40002524:7672" data-name="Vertical Divider" />
        <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[80px] left-[calc(50%+2849.5px)] overflow-clip rounded-[8px] top-1/2 w-[180px]" data-node-id="40002524:7673" data-name="Background">
          <div className="absolute inset-[30px_67px_30px_17px]" data-node-id="40002524:7674" data-name="SVG">
            <div className="absolute inset-0 overflow-clip" data-node-id="40002524:7675" data-name="svg-1193675701_6046">
              <div className="absolute contents inset-0" data-node-id="40002524:7676" data-name="Clip path group">
                <div className="absolute inset-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-size-[96px_20px]" data-node-id="40002524:7679" style={{ maskImage: `url('${imgGroup}')` }} data-name="Group">
                  <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgGroup6} />
                </div>
              </div>
            </div>
        ...
        <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+2964px)] top-1/2 w-px" data-node-id="40002524:7691" data-name="Vertical Divider" />
        <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[80px] left-[calc(50%+3078.5px)] overflow-clip rounded-[8px] top-1/2 w-[180px]" data-node-id="40002524:7692" data-name="Background">
          <div className="absolute inset-[34px_63px_34px_13px]" data-node-id="40002524:7693" data-name="SVG">
            <div className="absolute inset-0 overflow-clip" data-node-id="40002524:7694" data-name="svg-1200228636_8480">
              <div className="absolute contents inset-0" data-node-id="40002524:7695" data-name="Clip path group">
                <div className="absolute inset-[-0.18%_0.02%_-0.02%_0] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px_0.021px] mask-size-[104px_12px]" data-node-id="40002524:7698" style={{ maskImage: `url('${imgGroup7}')` }} data-name="Group">
                  <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgGroup8} />
                </div>
              </div>
            </div>
        ...
        <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+3193px)] top-1/2 w-px" data-node-id="40002524:7710" data-name="Vertical Divider" />
        <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[80px] left-[calc(50%+3307.5px)] overflow-clip rounded-[8px] top-1/2 w-[180px]" data-node-id="40002524:7711" data-name="Background">
          <div className="absolute inset-[34px_54px_34px_4px]" data-node-id="40002524:7712" data-name="SVG">
            <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgSvg} />
          </div>
        </div>
        <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+3422px)] top-1/2 w-px" data-node-id="40002524:7722" data-name="Vertical Divider" />
        <div className="absolute h-[80px] left-[4063.26px] overflow-clip top-0 w-[1350px]" data-node-id="40002524:7723" data-name="Item">
          <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[80px] left-[calc(50%-593.76px)] overflow-clip rounded-[8px] top-1/2 w-[180px]" data-node-id="40002524:7724" data-name="Background">
            <div className="absolute inset-[30px_67px_30px_17px]" data-node-id="40002524:7725" data-name="SVG">
              <div className="absolute inset-0 overflow-clip" data-node-id="40002524:7726" data-name="svg-2019416039_6035">
                <div className="absolute contents inset-0" data-node-id="40002524:7727" data-name="Clip path group">
                  <div className="absolute inset-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-size-[96px_20px]" data-node-id="40002524:7730" style={{ maskImage: `url('${imgGroup}')` }} data-name="Group">
                    <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgGroup1} />
                  </div>
                </div>
              </div>
          ...
          <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%-479.26px)] top-1/2 w-px" data-node-id="40002524:7742" data-name="Vertical Divider" />
          <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[80px] left-[calc(50%-364.76px)] overflow-clip rounded-[8px] top-1/2 w-[180px]" data-node-id="40002524:7743" data-name="Background">
            <div className="absolute inset-[31.01px_60px_31.04px_10px]" data-node-id="40002524:7744" data-name="SVG">
              <div className="absolute inset-0 overflow-clip" data-node-id="40002524:7745" data-name="svg241134563_7233">
                <div className="absolute contents inset-0" data-node-id="40002524:7746" data-name="Clip path group">
                  <div className="absolute inset-[-0.01%_0.01%_-0.01%_0] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px_0.002px] mask-size-[110px_17.95px]" data-node-id="40002524:7749" style={{ maskImage: `url('${imgGroup2}')` }} data-name="Group">
                    <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgGroup3} />
                  </div>
                </div>
              </div>
          ...
          <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%-250.26px)] top-1/2 w-px" data-node-id="40002524:7762" data-name="Vertical Divider" />
          <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[80px] left-[calc(50%-135.76px)] overflow-clip rounded-[8px] top-1/2 w-[180px]" data-node-id="40002524:7763" data-name="Background">
            <div className="absolute inset-[34px_59px_34px_9px]" data-node-id="40002524:7764" data-name="SVG">
              <div className="absolute inset-0 overflow-clip" data-node-id="40002524:7765" data-name="svg2145606225_4570">
                <div className="absolute contents inset-0" data-node-id="40002524:7766" data-name="Clip path group">
                  <div className="absolute inset-[0_-0.02%_0_0.01%] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-0.008px_0px] mask-size-[112px_12px]" data-node-id="40002524:7769" style={{ maskImage: `url('${imgGroup4}')` }} data-name="Group">
                    <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgGroup5} />
                  </div>
                </div>
              </div>
          ...
          <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%-21.26px)] top-1/2 w-px" data-node-id="40002524:7771" data-name="Vertical Divider" />
          <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[80px] left-[calc(50%+93.24px)] overflow-clip rounded-[8px] top-1/2 w-[180px]" data-node-id="40002524:7772" data-name="Background">
            <div className="absolute inset-[30px_67px_30px_17px]" data-node-id="40002524:7773" data-name="SVG">
              <div className="absolute inset-0 overflow-clip" data-node-id="40002524:7774" data-name="svg-1193675701_6046">
                <div className="absolute contents inset-0" data-node-id="40002524:7775" data-name="Clip path group">
                  <div className="absolute inset-0 mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-size-[96px_20px]" data-node-id="40002524:7778" style={{ maskImage: `url('${imgGroup}')` }} data-name="Group">
                    <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgGroup6} />
                  </div>
                </div>
              </div>
          ...
          <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+207.74px)] top-1/2 w-px" data-node-id="40002524:7790" data-name="Vertical Divider" />
          <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[80px] left-[calc(50%+322.24px)] overflow-clip rounded-[8px] top-1/2 w-[180px]" data-node-id="40002524:7791" data-name="Background">
            <div className="absolute inset-[34px_63px_34px_13px]" data-node-id="40002524:7792" data-name="SVG">
              <div className="absolute inset-0 overflow-clip" data-node-id="40002524:7793" data-name="svg-1200228636_8480">
                <div className="absolute contents inset-0" data-node-id="40002524:7794" data-name="Clip path group">
                  <div className="absolute inset-[-0.18%_0.02%_-0.02%_0] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0px_0.021px] mask-size-[104px_12px]" data-node-id="40002524:7797" style={{ maskImage: `url('${imgGroup7}')` }} data-name="Group">
                    <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgGroup8} />
                  </div>
                </div>
              </div>
          ...
          <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+436.74px)] top-1/2 w-px" data-node-id="40002524:7809" data-name="Vertical Divider" />
          <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[80px] left-[calc(50%+551.24px)] overflow-clip rounded-[8px] top-1/2 w-[180px]" data-node-id="40002524:7810" data-name="Background">
            <div className="absolute inset-[34px_54px_34px_4px]" data-node-id="40002524:7811" data-name="SVG">
              <img alt="" className="absolute block inset-0 max-w-none size-full" src={imgSvg} />
            </div>
          </div>
          <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#e9ebf1] h-[32px] left-[calc(50%+665.74px)] top-1/2 w-px" data-node-id="40002524:7821" data-name="Vertical Divider" />
        </div>
      </div>
      <div className="absolute bg-gradient-to-l from-[rgba(246,247,249,0)] h-[79px] left-0 to-[#f6f7f9] top-[0.6px] w-[60px]" data-node-id="40002524:7822" />
      <div className="absolute bg-gradient-to-l from-[#f6f7f9] h-[79px] right-0 to-[rgba(246,247,249,0)] top-[0.6px] w-[60px]" data-node-id="40002524:7823" />
    </div>
  );
}

export default function LandingV2Desktop1440Px() {
    ...
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-node-id="40002524:7910" data-name="Landing v2 / Desktop — 1440px">
      <div className="bg-white border border-[rgba(0,0,0,0.05)] border-solid content-stretch flex flex-col items-start overflow-clip relative shrink-0 w-[1440px]" data-node-id="40002524:7911" data-name="Header">
        <div className="content-stretch flex gap-[40px] h-[72px] items-center px-[120px] relative shrink-0 w-[1440px]" data-node-id="40002524:7912" data-name="header-inner">
          <div className="[word-break:break-word] content-stretch flex font-['SF_Pro_Display:Bold',sans-serif] gap-[4px] items-baseline leading-[1.5] not-italic overflow-clip relative shrink-0 text-[20px] tracking-[-0.4px] whitespace-nowrap" data-node-id="40002524:7913" data-name="brand">
          ...
          <div className="[word-break:break-word] content-stretch flex font-['SF_Pro:Medium',sans-serif] font-[510] gap-[28px] items-center leading-[0] overflow-clip relative shrink-0 text-[#595959] text-[14px] tracking-[-0.14px] whitespace-nowrap" data-node-id="40002524:7917" data-name="nav">
            ...
            <a className="block relative shrink-0" href="https://tgshop.io/shops/" data-node-id="40002524:7920" style={{ fontVariationSettings: "'wdth' 100" }} target="_blank">
              <p className="cursor-pointer leading-[1.5]">Помощь</p>
            </a>
            <a className="block relative shrink-0" href="https://uz.tgshop.io/ru/blog" data-node-id="40002524:7921" style={{ fontVariationSettings: "'wdth' 100" }} target="_blank">
          ...
          <div className="content-stretch flex gap-[12px] items-center relative shrink-0" data-node-id="40002524:7922" data-name="header-cta">
            <div className="border-[1.5px] border-[rgba(16,142,245,0.2)] border-solid content-stretch flex h-[40px] items-center justify-center overflow-clip px-[18px] relative rounded-[100px] shrink-0" data-node-id="40002524:7923" data-name="btn-outline">
              <a className="[word-break:break-word] block font-['SF_Pro:Semibold',sans-serif] font-[590] leading-[0] relative shrink-0 text-[#108ef5] text-[14px] tracking-[-0.14px] whitespace-nowrap" href="https://admin.tgshop.io/sign-in?utm_content=uz" data-node-id="40002524:7924" style={{ fontVariationSettings: "'wdth' 100" }} target="_blank">
            ...
            <div className="bg-[#108ef5] content-stretch flex h-[40px] items-center justify-center overflow-clip px-[18px] relative rounded-[100px] shadow-[0px_12px_24px_0px_rgba(51,133,255,0.22)] shrink-0" data-node-id="40002524:7925" data-name="btn-primary">
              <a className="[word-break:break-word] block font-['SF_Pro:Semibold',sans-serif] font-[590] leading-[0] relative shrink-0 text-[14px] text-white tracking-[-0.14px] whitespace-nowrap" href="https://admin.tgshop.io/sign-up?utm_content=uz" data-node-id="40002524:7926" style={{ fontVariationSettings: "'wdth' 100" }} target="_blank">
        ...
        <div className="content-stretch flex gap-[40px] h-[493px] items-center relative shrink-0 w-full" data-node-id="40002524:7928" data-name="hero-inner">
          <div className="content-stretch flex flex-col items-start relative shrink-0 w-[560px]" data-node-id="40002524:7929" data-name="left">
            ...
            <div className="content-stretch flex items-start relative shrink-0" data-node-id="40002524:7938" data-name="cta-row">
              <a href="https://admin.tgshop.io/sign-up?utm_content=uz" target="_blank" rel="noopener" className="contents no-underline">
          ...
          <div className="h-[488px] relative shrink-0 w-[708px]" data-node-id="40002524:7945" data-name="right">
            ...
            <div className="absolute flex h-[112.65px] items-center justify-center left-[498.56px] top-[24px] w-[173.213px]">
              <div className="flex-none rotate-3">
                <div className="[word-break:break-word] bg-white drop-shadow-[0px_12px_15px_rgba(79,209,146,0.22)] h-[104px] not-italic relative rounded-[16px] w-[168px] whitespace-nowrap" data-node-id="40002526:7864" data-name="badge-37orders">
                  ...
                  <div className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[0] left-[20px] text-[#4d5966] text-[13px] top-[56px]" data-node-id="40002526:7866">
                    <p className="leading-[18px] mb-0">новых заказов</p>
                    <p className="leading-[18px]">сегодня</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="[word-break:break-word] absolute bg-white drop-shadow-[0px_12px_15px_rgba(13,18,31,0.1)] h-[104px] left-[520px] not-italic rounded-[16px] top-[376px] w-[156px] whitespace-nowrap" data-node-id="40002526:7867" data-name="badge-12msg">
              ...
              <div className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[0] left-[20px] text-[#4d5966] text-[13px] top-[56px]" data-node-id="40002526:7869">
                <p className="leading-[18px] mb-0">новых</p>
                <p className="leading-[18px]">заявок в чатах</p>
              </div>
            </div>
          </div>
        </div>
      </div>
      <div className="bg-[#f6f7f9] border border-[rgba(0,0,0,0.04)] border-solid content-stretch flex flex-col items-center overflow-clip px-[120px] py-[56px] relative shrink-0 w-[1440px]" data-node-id="40002524:8037" data-name="Trust">
            ...
            <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full" data-node-id="40002690:8540">
              ...
              <div className="content-stretch flex gap-[34px] h-[63px] items-start relative shrink-0 w-full" data-node-id="40002690:8541">
                ...
                <div className="content-stretch flex flex-col gap-[6px] items-start relative shrink-0" data-node-id="40002690:8545">
                  <div className="[word-break:break-word] font-['SF_Pro:Heavy',sans-serif] font-[860] leading-[0] relative shrink-0 text-[#8c949e] text-[24px] tracking-[-0.912px] whitespace-nowrap" data-node-id="40002690:8546" style={{ fontVariationSettings: "'wdth' 100" }}>
                    <p className="leading-[normal] mb-0 whitespace-pre">{`740 `}</p>
                    <p className="leading-[normal] whitespace-pre">заказов</p>
                  </div>
      ...
      <div className="bg-white content-stretch flex flex-col items-center overflow-clip p-[120px] relative shrink-0 w-[1440px]" data-node-id="40002633:420" data-name="Price">
        <div className="h-[579px] relative shrink-0 w-[1200px]" data-node-id="40002633:421" data-name="price-inner">
          <div className="absolute content-stretch flex flex-col items-start left-0 top-0 w-[568px]" data-node-id="40002633:422" data-name="price-text">
            ...
            <p className="[word-break:break-word] font-['SF_Pro_Display:Regular',sans-serif] leading-[1.55] not-italic relative shrink-0 text-[#767d88] text-[15px] tracking-[-0.15px] w-[568px]" data-node-id="40002633:477">
      ...
      <div className="bg-[#f6f7f9] content-stretch flex flex-col items-center overflow-clip px-[120px] py-[90px] relative shrink-0 w-[1440px]" data-node-id="40002524:8481" data-name="Pricing">
        <div className="content-stretch flex flex-col items-center overflow-clip relative shrink-0 w-[820px]" data-node-id="40002524:8482" data-name="section-head">
          <div className="bg-[rgba(16,142,245,0.08)] content-stretch flex items-start overflow-clip px-[12px] py-[6px] relative rounded-[100px] shrink-0" data-node-id="40002524:8483" data-name="kicker">
            <p className="[word-break:break-word] font-['SF_Pro_Display:Semibold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#108ef5] text-[14px] tracking-[-0.14px] whitespace-nowrap" data-node-id="40002524:8484">
              Тарифы
            </p>
          </div>
      ...
      <div className="bg-[#121721] border border-[rgba(0,0,0,0.04)] border-solid content-stretch flex flex-col items-start overflow-clip pb-[24px] pt-[48px] px-[120px] relative shrink-0 w-[1440px]" data-node-id="40002524:8678" data-name="Footer">
        <div className="content-stretch flex gap-[40px] items-start overflow-clip relative shrink-0 w-[1200px]" data-node-id="40002524:8679" data-name="footer-top">
          ...
          <div className="content-stretch flex flex-col gap-[10px] items-start overflow-clip relative shrink-0 w-[200px]" data-node-id="40002524:8685" data-name="fc">
            ...
            <a className="[word-break:break-word] block font-['SF_Pro:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[#a6b0bf] text-[14px] tracking-[-0.14px] whitespace-nowrap" href="https://tgshop.io/yearly/" data-node-id="40002524:8690" style={{ fontVariationSettings: "'wdth' 100" }} target="_blank">
              <p className="cursor-pointer leading-[1.5]">Тарифы</p>
            </a>
