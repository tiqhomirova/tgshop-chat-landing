...
const img221 = "/tgshop-chat-landing/assets/logo-merci-lingerie.png";
const img51 = "/tgshop-chat-landing/assets/logo-dragonfly.png";
            ...
            <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full" data-node-id="40002690:8540">
              ...
              <div className="content-stretch flex gap-[34px] h-[63px] items-start relative shrink-0 w-full" data-node-id="40002690:8541">
                ...
                <div className="content-stretch flex flex-col gap-[6px] items-start relative shrink-0" data-node-id="40002690:8545">
                  <div className="[word-break:break-word] font-['SF_Pro:Heavy',sans-serif] font-[860] leading-[0] relative shrink-0 text-[#f04545] text-[24px] tracking-[-0.912px] whitespace-nowrap" data-node-id="40002690:8546" style={{ fontVariationSettings: "'wdth' 100" }}>
